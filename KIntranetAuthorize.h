...
class KIntranetAuthorize : public QObject, public virtual IKIntranetAuthorize {
    Q_OBJECT
public:
    explicit KIntranetAuthorize(QObject* parent = nullptr);
    // ========================================================================
    ...
    // [15..18] 扩展功能
    int __stdcall GetAuthorizedTimeRange(int featureId, time_t* startTime, time_t* endTime) override;
